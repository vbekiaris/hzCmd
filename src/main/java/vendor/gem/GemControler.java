    ...
    public void init(NodeType type) throws Exception {
        if(type == NodeType.Member){
            ...
            if(ID.equals("GemMember1F")){
                ...
                .set("start-locator","localhost[13489]").set("locators", "54.172.198.157[13489]").create();

            } else {
                serverCache = new CacheFactory().set("cache-xml-file", "server-cache.xml").set("mcast-port", "0").set("locators", "54.172.198.157[13489]").create();
            }
