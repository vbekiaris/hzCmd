    ...
    public void init(NodeType type) throws Exception {
        if(type == NodeType.Member){
            ...
            if(ID.equals("GemMember1F")){
                ...
                .set("start-locator","10.0.0.192[13489]").set("locators", "10.0.0.192[13489]").create();

            } else {
                serverCache = new CacheFactory().set("cache-xml-file", "server-cache.xml").set("mcast-port", "0").set("locators", "10.0.0.192[13489]").create();
            }
