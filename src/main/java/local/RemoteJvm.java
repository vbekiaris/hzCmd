...
public abstract class RemoteJvm implements Serializable {
    ...
    public void startJvm(String jvmOptions, String libDir, ClusterManager myCluster, String brokerIP) throws Exception {
        ...
        if(properties.getBoolean(HzCmdProperties.JFR, "true") && type == NodeType.Member) {
            ...
            jvmArgs += "-XX:+UnlockCommercialFeatures -XX:+FlightRecorder -XX:StartFlightRecording=name="+id+".jfr ,settings=profile -XX:FlightRecorderOptions=defaultrecording=true,disk=true,maxsize=1g,maxage=1h,dumponexit=true";
        }
